...
- **Continuous Improvement**: Pilots run as _PilotWorks_ streams; successful modules promoted to full product.
...
- **Energy Management**: BMS/EMS integration, energy optimisation algorithms, carbon tracking, real-time energy intelligence.
- **AI Intelligence**: Machine learning model training, anomaly detection, predictive maintenance, automated red-flagging.
- **Graph Intelligence**: Function-based asset modeling, relationship analysis, multiple hierarchy support, scenario planning.
- **Hybrid Database Management**: PostgreSQL and Azure Cosmos DB synchronization, conflict resolution, performance optimization.
