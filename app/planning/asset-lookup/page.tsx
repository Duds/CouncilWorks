...
export default function AssetLookupPage() {
  ...
  return (
    <AppLayout
      ...
      title="Asset Lookup"
      description="Purpose-driven asset search and discovery"
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Find assets by service purpose, not just asset type
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Search for assets by their service purpose, contribution, or function
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <Card key={asset.id} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    <div className="text-sm font-medium text-muted-foreground">Service Purpose</div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="text-xs text-muted-foreground">
                      Next: {new Date(asset.nextInspection).toLocaleDateString('en-AU')}
                    </div>
                  </div>
